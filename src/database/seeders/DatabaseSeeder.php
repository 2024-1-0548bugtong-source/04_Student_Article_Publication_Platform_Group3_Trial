...
class DatabaseSeeder extends Seeder
{
    ...
    private function generateSampleData(): void
    {
        ...
        // Helper to randomize timestamps within the last 365 days
        $randomTimestamp = function() {
            $daysAgo = rand(0, 364);
            $seconds = rand(0, 86400);
            return Carbon::now()->subDays($daysAgo)->subSeconds($seconds);
        };
        ...
        // Truncate articles and reviews tables to avoid duplicate slugs and reviews
        ...
        $revisionArticle1 = Article::firstOrCreate(
        ...
        $revisionArticle2 = Article::firstOrCreate(
